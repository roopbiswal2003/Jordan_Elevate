import "./Login.css";
import socialDesktop from "../images/social-desktop.gif";
import socialMobile from "../images/social-mobile.gif";
    ...
    <div className="container login-container">
      <div className="row d-flex align-items-center justify-center">
        <div className="col-lg-7 col-md-5 col-sm-12 d-flex justify-content-center  align-items-center">
          <img
            className="socialDesktop rounded-circle"
            style={{ width: "87%" }}
            src={socialDesktop}
            alt="Logo"
          />
          <img className="socialMobile" style={{ width: "87%" }} src={socialMobile} alt="Logo" />
        </div>
